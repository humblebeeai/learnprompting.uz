      ...
      <div className="hero-content">
        ...
        >
          <Translate id="homepage.hero.subtitle">
            ChatGPT, Claude va boshqa AI vositalari bilan professional darajada
            ishlash ko'nikmalarini egallang. Bepul, ochiq manbali qo'llanma.
          </Translate>
        </p>
        ...
        >
          <Link className="btn-primary" to="/docs/intro">
            <span>
              <Translate id="homepage.hero.button.start">Boshlash</Translate>
            </span>
        ...
        >
          <StatItem
            value="3M+"
            label={
              <Translate id="homepage.stats.learners">O'quvchilar</Translate>
            }
          />
          <div className="stat-divider" />
          <StatItem
            value="60+"
            label={<Translate id="homepage.stats.modules">Modullar</Translate>}
          />
          <div className="stat-divider" />
          <StatItem
            value="100%"
  ...
  const features = [
    {
      ...
      description: (
        <Translate id="homepage.features.stepbystep.description">
          Oddiy tushunchalardan murakkab texnikalargacha tizimli ravishda
          o'rganing
        </Translate>
      ),
    },
    {
      ...
      description: (
        <Translate id="homepage.features.practice.description">
          Har bir darsda real vazifalar va interaktiv mashqlar bilan
          mustahkamlang
        </Translate>
      ),
    },
    {
      ...
      title: (
        <Translate id="homepage.features.community.title">Hamjamiyat</Translate>
      ),
      description: (
        <Translate id="homepage.features.community.description">
          O'zbek tilidagi AI ishqibozlari hamjamiyatiga qo'shiling
        </Translate>
      ),
    },
  ];
  ...
  const steps = [
    {
      ...
      description: (
        <Translate id="homepage.path.step1.description">
          Sun'iy intellekt qanday ishlashini tushuning
        </Translate>
      ),
      color: "#10b981",
    },
    {
      number: "02",
      title: (
        <Translate id="homepage.path.step2.title">Prompt yozish</Translate>
      ),
      description: (
        <Translate id="homepage.path.step2.description">
          Samarali so'rovlar tuzishni o'rganing
        </Translate>
      ),
      color: "#06b6d4",
    },
    {
      number: "03",
      title: (
        <Translate id="homepage.path.step3.title">Ilg'or texnikalar</Translate>
      ),
      description: (
        <Translate id="homepage.path.step3.description">
          Professional usullarni egallang
        </Translate>
      ),
      color: "#8b5cf6",
    },
    {
      number: "04",
      title: (
        <Translate id="homepage.path.step4.title">Amaliy qo'llash</Translate>
      ),
      description: (
        <Translate id="homepage.path.step4.description">
          Real loyihalarda foydalaning
        </Translate>
      ),
      color: "#f59e0b",
    },
  ...
  return (
    <section ref={ref} className="path-section">
      <div className="section-container">
        ...
        >
          <span className="section-label">
            <Translate id="homepage.path.label">O'quv yo'li</Translate>
          </span>
          <h2 className="section-title">
            <Translate id="homepage.path.mainTitle">
              4 bosqichda professional darajaga yeting
            </Translate>
          </h2>
        </div>
        ...
        >
          ...
          <p className="cta-description">
            <Translate id="homepage.cta.description">
              3 million dan ortiq o'quvchilarga qo'shiling va AI bilan ishlash
              mahoratini egallang
            </Translate>
          </p>
