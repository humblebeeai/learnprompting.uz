---
sidebar_position: 5
title: "🟡 Prompt ansambl qilish"
---


# Promptlarni ansambl qilish

Prompt ansambl qilish(ensembling) — bu bir nechta turli promptlardan foydalanish orqali harakat qilish tushunchasidir
Xuddi shu savolga javob bering. Buning uchun turli xil yondashuvlar mavjud.

## DiVeRSe

DiVeRSe (@li2022advance) Fikrlash bosqichlarini turli xil tekshiruvchilar orqali tasdiqlash("**Di**verse **Ve**rifier on **R**easoning **S**t**e**ps") bu
...
```text
Kermode ayiği, ba’zan ruh ayiği deb ham ataladi (Ursus americanus kermodei), Amerika qora ayiğinin kichik turi bo‘lib, Kanada, Britaniya Kolumbiyasining Markaziy va Shimoliy sohil hududlarida yashaydi.
```

Siz bu vazifani quyidagicha promptga formatlashingiz mumkin:

```text
Quyidagi da'vo kontekstga ko‘ra To‘g‘ri yoki Noto‘g‘ri ekanligini aniqlang.

Kermode ayiği, ba’zan ruh ayiği deb ham ataladi (Ursus americanus kermodei), Amerika qora ayiği ning kichik turi bo‘lib, Kanada ning Britaniya Kolumbiyasi markaziy va shimoliy sohil hududlarida yashaydi.
...
```text
Kermode ayiği, ba’zan spirit bear deb ham ataladi (Ursus americanus kermodei), Amerika qora ayiği ning kichik turi bo‘lib, Kanada ning Britaniya Kolumbiyasi markaziy va shimoliy sohil hududlarida yashaydi.
...
Bu yerda birinchi qadamingiz `Bu hayvon Shimoliy Amerikada yashaydi.` da'vosini olib, uni turli savollarga qayta formatlash bo'ladi, ular asosan bir xil narsani so'ramoqda. Buni amalga oshirish uchun, biz da'voni quyidagi rasmda ko'rsatilgan promptlar orqali o'tkazamiz.
...
```text
Kermode ayiği, ba’zan ruh ayiği deb ham ataladi (Ursus americanus kermodei), Amerika qora ayiğining kichik turi bo‘lib, Kanadaning Britaniya Kolumbiyasi markaziy va shimoliy sohil hududlarida yashaydi.
