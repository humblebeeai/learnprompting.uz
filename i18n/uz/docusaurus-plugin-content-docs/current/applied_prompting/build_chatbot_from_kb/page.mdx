...
An’anaviy intentga asoslangan chatbot qanday ishlaydi. Muallif tomonidan yaratilgan rasm.
  </p>
</div>

Biroq, intentga asoslangan chatbotlarning o‘ziga xos muammolari bor. Masalan, ular aniq javoblar berish uchun juda ko‘p sonli intentlarni talab qiladi. Masalan, “Kira olmayapman”, “Parolimni unutdim” yoki “Kirishda xato” kabi foydalanuvchi so‘zlari uch xil javob va shuning uchun uch xil intentni talab qilishi mumkin, garchi ular bir-biriga juda o‘xshash bo‘lsa ham.

## GPT-3 qanday yordam bera oladi

Mana shu yerda GPT-3 ayniqsa foydali bo‘lishi mumkin. Juda ko‘p aniq intentlar o‘rniga, har bir intent kengroq bo‘lishi va sizning [Knowledge Base](https://en.wikipedia.org/wiki/Knowledge_base) dan biror hujjatga tayanishi mumkin. Knowledge Base (KB) — bu tahlil yoki xulosa chiqarish uchun tayyor holda saqlangan tuzilgan va tuzilmagan ma’lumotlardir. Sizning KB’ingiz mahsulotlaringizdan qanday foydalanish haqida tushuntiruvchi hujjatlar to‘plamidan iborat bo‘lishi mumkin.

Bu usulda har bir intent savollar ro‘yxati va aniq javob o‘rniga biror hujjatga bog‘lanadi, masalan, “kirish muammolari” uchun bitta intent, “obuna bo‘lish tartibi” uchun yana bir intent va hokazo. Foydalanuvchi kirish haqida savol berganda, “kirish muammolari” hujjatini GPT-3 ga kontekst sifatida uzatib, foydalanuvchi savoliga aniq javob yaratishimiz mumkin.
...
<div style={{ textAlign: "left" }}>
  ...
  <p style={{ color: "gray", fontSize: "12px", fontStyle: "italic" }}>
GPT-3 dan foydalangan chatbot qanday ishlashi mumkin. Muallif tomonidan yaratilgan rasm.
  </p>
</div>

Bu yondashuv boshqarilishi kerak bo‘lgan intentlar sonini kamaytiradi va har bir savolga yaxshiroq moslashtirilgan javoblar olish imkonini beradi. Bundan tashqari, agar intentga bog‘langan hujjatda turli jarayonlar (masalan, “veb-saytda kirish” va “mobil ilovada kirish” jarayoni) tasvirlangan bo‘lsa, GPT-3 foydalanuvchidan aniqlik kiritishni so‘rab, so‘ngra yakuniy javobni bera oladi.
...
<div style={{ textAlign: "left" }}>
  ...
  <p style={{ color: "gray", fontSize: "12px", fontStyle: "italic" }}>
GPT-3 dan foydalangan chatbot qanday ishlashi mumkin. GPT-3 quyidagilar uchun ishlatilishi mumkin
knowledge base’dagi ma’lumotlardan foydalanib
mos javob yaratish. Muallif tomonidan yaratilgan rasm.
  </p>
</div>
...
<div style={{ textAlign: "left" }}>
  ...
  <p style={{ color: "gray", fontSize: "12px", fontStyle: "italic" }}>
GPT-3 promptini tuzishda ishlatiladigan ma’lumotlar. Muallif tomonidan yaratilgan rasm.
  </p>
</div>
...
<div style={{ textAlign: "left" }}>
  ...
  <p style={{ color: "gray", fontSize: "12px", fontStyle: "italic" }}>
VideoGram’ga kirish qanday ishlashini tushuntiruvchi hujjat. Muallif tomonidan yaratilgan rasm.
  </p>
</div>
...
VideoGram’ga veb-sayt orqali kirish
    ...
    2. Sahifaning yuqori o‘ng burchagida joylashgan “Kirish” tugmasini bosing.
    3. Kirish sahifasida VideoGram foydalanuvchi nomi va parolingizni kiriting.
    4. Ma’lumotlaringizni kiritganingizdan so‘ng, “Kirish” tugmasini bosing.
...
VideoGram’ga mobil ilova orqali kirish
    ...
    2. Asosiy sahifada pastki o‘ng burchakda joylashgan “Kirish” tugmasini bosing.
    3. Kirish sahifasida VideoGram foydalanuvchi nomi va parolingizni kiriting.
    4. Ma’lumotlaringizni kiritganingizdan so‘ng, “Kirish” tugmasini bosing.
...
Oxirida, <span className="yellow-highlight">suhbat va foydalanuvchi savolini</span> prompt oxiriga qo‘shishimiz kerak, quyidagi misoldagidek.
...
VideoGram’ga Veb-saytdan kirish
  ...
  2. Sahifaning yuqori o‘ng burchagida joylashgan “Login” tugmasini bosing.
  3. Login sahifasida VideoGram foydalanuvchi nomi va parolingizni kiriting.
  4. Ma’lumotlaringizni kiritganingizdan so‘ng, “Login” tugmasini bosing.
  5. Siz endi VideoGram akkauntingizga tizimga kirdingiz.
  <br/>
VideoGram’ga Mobil Ilovadan kirish
  1. Mobil qurilmangizda VideoGram ilovasini oching.
  2. Asosiy sahifada, pastki o‘ng burchakda joylashgan “Login” tugmasini bosing.
  3. Login sahifasida VideoGram foydalanuvchi nomi va parolingizni kiriting.
  4. Ma’lumotlaringizni kiritganingizdan so‘ng, “Login” tugmasini bosing.
  5. Siz endi VideoGram akkauntingizga tizimga kirdingiz.
...
Keling, yanada noaniq foydalanuvchi so‘rovi bilan urinib ko‘ramiz, masalan <span className="yellow-highlight">“kira olmayapman”</span>. Mana to‘liq prompt.
...
mobil qurilmangizda. Asosiy sahifada, pastki o‘ng burchakda joylashgan “Login” tugmasini bosing
tizimga kirish sahifasida VideoGram foydalanuvchi nomingizni
va parolingizni kiriting. Ma’lumotlaringizni kiritganingizdan so‘ng, “Login”
...
Agar biz “Mobil ilova bepulmi?” deb so‘rasak va kontekst sifatida login hujjatini GPT-3 ga uzatsak, ko‘pincha “Ha, VideoGram mobil ilovasi bepul yuklab olinadi va ishlatiladi” kabi javob olasiz, hatto bunday ma’lumot kontekstda mavjud bo‘lmasa ham. Noto‘g‘ri ma’lumot yaratish mijozlarga xizmat ko‘rsatish chatbotlari uchun juda yomon!
