---
sidebar_position: 4
title: "🟡 Kod sifatida mantiqlash"
---


# Kod sifatida mantiqlash

[Program-aided Language Models (PAL)Dastur yordamida qo‘llab-quvvatlangan til modellari](https://reasonwithpal.com)(@gao2022pal) MRKL tizimining yana bir namunasi hisoblanadi.
...
Yuqoridagi rasmda ko'k rangda PAL tomonidan yaratilgan tabiiy til asosidagi mulohazalar ko'rsatilgan. Garchi u
rasmda ko'rsatilmagan bo'lsa-da, PAL aslida NL asoslantirishining har bir qatori oldidan '\#' hosil qiladi, shuning uchun
ular dasturiy bajarilish muhiti tomonidan izoh sifatida talqin qilinadi.

## Misol

Keling, PAL matematik savolni qanday yechishini misol orqali ko'ramiz. Men 3-shot prompt dan foydalanaman,
...
Men buning uchun LLM funksionalligini zanjirlash uchun Python paketi bo'lgan langchain'dan foydalanaman. Avvalo, bir nechta o'rnatishlar kerak bo'ladi:
...
```python
MATH_PROMPT = '''
Q: Savol: Server xonasida to‘qqizta kompyuter bor edi. Dushanbadan payshanbagacha har kuni yana beshtadan kompyuter o‘rnatildi. Hozir server xonasida nechta kompyuter bor?
# Yechim in Python:
"""Savol: Server xonasida to‘qqizta kompyuter bor edi. Dushanbadan payshanbagacha har kuni yana beshtadan kompyuter o‘rnatildi. Hozir server xonasida nechta kompyuter bor?"""
...
Q:Savol: Shonning beshta o‘yinchog‘i bor. Rojdestvoda u onasidan va otasidan ikki tadan o‘yinchoq oldi. Hozir uning nechta o‘yinchog‘i bor?

# Yechim  Pythonda:
"""Savol: Shonning beshta o‘yinchog‘i bor. Rojdestvoda u onasidan va otasidan ikki tadan o‘yinchoq oldi. Hozir uning nechta o‘yinchog‘i bor?"""
...
Emma Sietlga 60 daqiqalik samolyot parvozida bordi. So'ngra u 2 soatlik poezdda yo'l oldi.
Portlandga borish, so'ngra 30 daqiqalik avtobus yo'li orqali Vankuverga yetib borish. Qancha vaqt ketadi
...
Natija **210**, bu to'g'ri.

Ushbu misol uchun Jupyter daftarini [bu yerda](https://github.com/trigaten/Learn_Prompting/tree/main/docs/code_examples/PAL.ipynb) ko'ring.
