...
export default function AboutCollaboration() {
	...
	return (
		<Layout
			title="Loyiha Haqida"
			description="Learn Prompting O'zbekcha tarjimasi haqida"
		>
			{/* Hero Section */}
			<section
			...
			>
				...
				>
					...
					<p style={{ fontSize: "1.2rem", color: "var(--color-text-secondary)", marginBottom: "0.5rem" }}>
						<strong>O'zbekcha nashr:</strong> HumblebeeAI
					</p>

					<p style={{ fontSize: "0.85rem", opacity: 0.7, maxWidth: "600px", margin: "0 auto 2rem" }}>
						Eslatma: Bu sahifa Learn Prompting asosidagi mustaqil o‘zbekcha nashr bo‘lib, rasmiy tasdiq yoki hamkorlikni anglatmaydi. (<Link to="/legal">Litsenziya</Link>)
					</p>
					...
					>
						Maqsadimiz - global bilimlarni o'zbek tilida erkin va bepul taqdim etish orqali O'zbekistonda AI savodxonligini oshirish.
					</p>
					...
					<div className="row" style={{ alignItems: "flex-start", justifyContent: "center", gap: "2rem" }}>
						...
						<div className="col col--5" style={{ textAlign: "center", marginBottom: "2rem" }}>
							<h3 style={{ fontSize: "1.5rem", marginBottom: "1rem" }}>
								Learn Prompting (Asl Loyiha)
							</h3>
							<p style={{ color: "var(--color-text-secondary)" }}>
								Dunyo bo'ylab millionlab o'quvchilar foydalanadigan ochiq manbali kurs. Generativ AI va Prompt Engineering bo'yicha eng keng qamrovli  va bepul qo'llanma.
							</p>
							<a href="https://learnprompting.org" target="_blank" className="button button--secondary button--sm">
								Asl saytga o'tish
							</a>
						</div>
						...
						<div className="col col--5" style={{ textAlign: "center", marginBottom: "2rem" }}>
							<h3 style={{ fontSize: "1.5rem", marginBottom: "1rem" }}>
								O'zbekcha nashr haqida
							</h3>
							<p style={{ color: "var(--color-text-secondary)" }}>
								HumblebeeAI jamoasi ushbu kursni o'zbek tiliga moslashtirdi va platformani yuritib boradi. Maqsadimiz - zamonaviy AI bilimlarini o'zbek tilida erkin taqdim etish.
							</p>
							<a href="https://humblebee.ai" target="_blank" className="button button--secondary button--sm">
								HumblebeeAI haqida
							</a>
						</div>
					</div>
				...
				<div className="container">
					<div className="row">
						...
						<div className="col col--6">
							...
							<p>
								Bu loyiha hamjamiyat tomonidan ochiq manba asosida yuritiladi.
