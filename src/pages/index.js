        ...
        <div className="collab-diagram">
          ...
          >
            <div style={{ marginBottom: "2rem" }}>
              ...
              >
                Learn Prompting - dunyo bo‘ylab millionlab foydalanuvchilar
                foydalanadigan ochiq manbali ta’lim loyihasi.
              </p>
            </div>
          ...
          >
            ...
            <div style={{ marginBottom: "2rem" }}>
              ...
              >
                O‘zbekcha nashr{" "}
                <span
                  style={{ fontWeight: 400, opacity: 0.6, fontSize: "0.8em" }}
                >
                  (rasmiy tarjima)
                </span>
              </h3>
              ...
              >
                Ushbu sahifa Learn Prompting asosidagi{" "}
                <strong>rasmiy o‘zbekcha tarjima</strong> bo‘lib, HumblebeeAI
                jamoasi tomonidan <strong>ochiq litsenziya asosida</strong>{" "}
                yuritiladi.
              </p>
            </div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <a
                    href="https://github.com/humblebeeai/learnprompting.uz/pulls"
                    target="_blank"
                    style={{
                      color: "var(--color-brand-primary)",
                      textDecoration: "none",
